shinyUI(fluidPage(theme = "yeti.css", #sandstone #slate good until final DT output # united good except orange
                  ...
                  navbarPage('Ecoregion 69 BCG Model: Fish',
                             ...
                             tabPanel('Subbasin Connection',
                                      sidebarPanel(
                                        ...
                                        p("Press 'Connect SubBasins' button to link uploaded data to subbasin geospatial file. Review all uploaded sites to ensure they are plotting in the correct location. An 
                                          ...
                                          all information is correct, proceed to the next tab."),
                             ...
                             tabPanel('BGC Model Results',
                                      sidebarPanel(
                                        h4(strong('Instructions:')),
                                        p("Once you have ensured the sites are plotting in the correct Subbasin, click 'Run BCG Model' to run the model. Once the calculations are complege, results will be displayed in a table
